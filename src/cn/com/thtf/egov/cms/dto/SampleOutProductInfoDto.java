...
public class SampleOutProductInfoDto {
	...
	private Integer outUseCount;       //借出可用数
	...
	/**
	 * @return the outUseCount
	 */
	public Integer getOutUseCount() {
		return outUseCount;
	}

	/**
	 * @param outUseCount the outUseCount to set
	 */
	public void setOutUseCount(Integer outUseCount) {
		this.outUseCount = outUseCount;
	}
