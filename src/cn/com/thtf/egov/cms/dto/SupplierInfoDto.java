...
public class SupplierInfoDto implements Serializable {
	...
	private String area;// 供货商所属区域

	private String province;// 供货商所属省

	private String city;// 供货商所属市

	private String address;// 供货商地址

	private String postcode;// 供货商地址邮编
	...
	private String supplierAddress;// 供货商发货地址

	private String supplierPostcode;// 供货商发货地址邮编

	private String supplierLinkman;// 供货商发货地址联系人

	private String supplierTel;// 供货商发货地址联系人电话

	private String supplierMobile;// 供货商发货地址联系人手机

	// private Integer supplierFlag;// 供货商的发货地址是否正在使用
