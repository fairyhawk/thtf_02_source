...
public class ImageServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -2242260433842183880L;
	...
	protected void processRequest(HttpServletRequest request,
		...
		// 将认证码存入SESSION
		session.setAttribute(Constants.SESSION_CONFIRM_STR, sRand.toString());
		// 图象生效
		g.dispose();
	...
	public String getServletInfo() {
		return "Create random confirm image";
	}
}
