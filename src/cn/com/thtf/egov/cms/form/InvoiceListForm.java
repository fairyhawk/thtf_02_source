...
public class InvoiceListForm extends ActionForm {
	...
	private InvoiceListDto invoiceListDto = new InvoiceListDto();
	...
	public InvoiceListDto getInvoiceListDto() {
		return invoiceListDto;
	}

	public void setInvoiceListDto(InvoiceListDto invoiceListDto) {
		this.invoiceListDto = invoiceListDto;
	}
