  	...
  	$(document).ready(function() {
			$("#addBuyBackForm").validate({
				rules: { 
					...
					"addBuyBackForm.money":{required:true,number:true,backMoneyCheckZero:true,backMoneyCheck:true}
				},
				messages: {
...
<body>
<html:form action="modifyBuyBack.do" styleId="addBuyBackForm">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td class="ye_header_center"><img src="${ctx}/images/main_jt.jpg" />&nbsp; 当前位置： 采购管理 &gt;&gt; 采购退款管理 &gt;&gt; 采购退款修改</td>
    ...
    <td align="center"><br/>
      ...
      <input type="hidden" name="addBuyBackForm.id" value="${backAddDto.id}">
        ...
        <tr>
          ...
          <td colspan="3" class="td_02"><textarea name="addBuyBackForm.text" id="addBuyBackForm.text" cols="100" rows="4" >${backAddDto.text}</textarea>
          </td>
        </tr>
      </table></td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <img src="${ctx}/images/btnUpdate.gif" onclick="sub()"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
