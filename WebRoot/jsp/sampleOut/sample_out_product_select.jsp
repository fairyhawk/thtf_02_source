...
<script language="JavaScript"> 
    ...
    function toParentsValue(obj) 
    {
		...
		var priceTax = instockmsg[5];
		var useCount = instockmsg[6];
		var timeStamp = instockmsg[7];
		var price = instockmsg[8];
		   
		if(obj.checked==true) {
			myArrayMoveStock.push([productid,productcode,productname,producttype,unit,priceTax,useCount,timeStamp,price]);
		}
...
<body>
<html:form action="getSampleOutProductSelect.do" styleId="getMoveProductSelectForm" >
        ...
        <div style="display: ; " class="mo_con" >
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="biao3">
            ...
            <tr>
              ...
              <td class="td_02"><input type="text" name="productName" id="productName" style="width:240px;" value="${moveStockProductDto.productName}"/></td>
            </tr>
            <tr>
    ...
    <td align="center">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="biao1" id="table" style="border-left:1px solid #FFFFFF;">
        ...
        <tr>
          ...
          value="${productDto.id}#${productDto.code}#${productDto.productName}#${productDto.type}#${productDto.unit}#${productDto.priceTax}#${productDto.useCount}#${productDto.timeStamp}#${productDto.price}"
          ...
          <c:if test="${USERLOGIN.roleId!=4 }">
          <td nowrap="nowrap" style="text-align:right;" name="priceTaxTd"><fmt:formatNumber value="${productDto.priceTax}" pattern="#,##0.00"/>&nbsp;</td>
         </c:if>
