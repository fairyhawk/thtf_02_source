...
<title>供货商选择</title>
		...
		<script language="JavaScript"> 
			...
			function searchSupplier(){
				...
				document.forms[0].action = "getSampleOutSupplierSelect.do?supplierName="+encodeURI(supplierName,"UTF-8");
				$("#frmSupplier").submit();
			}
			...
			window.opener.document.getElementById("companyId").value = supplierId;
			  
			$("#disPlayName",window.opener.document).html(supplierName);
			//关闭子窗口
			window.close();
...
<body>
<form action="getSampleOutSupplierSelect.do" method="post" id ="frmSupplier">
