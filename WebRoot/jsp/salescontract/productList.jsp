	...
	<body><br/>
		 <table id="productTable" width="96%" border="0" cellpadding="0" cellspacing="0" align="center" class="biao1">
			...
			<logic:iterate id="product" name="productList" indexId="num">
				<c:if test="${product.yfhNum<(product.count+product.thsNum)}">
				<tr>
					<td>
						<input type="checkbox" id="prodCh${num}" value="${product.productId}&${product.productCode}&${product.productName}&${product.productType}&${product.productUnit}&${product.count}&${product.price}&${product.money}&${product.yfhNum}&${product.qtkfNum}&${product.bkfNum}&${product.thsNum}&${product.fhkyNum+product.bkfNum}">
					</td>
