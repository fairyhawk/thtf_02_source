	...
	<head>
		...
		$(document).ready(function(){	
			...
			$(".preview").bind("click",function(){
				previewContract('${ctx}',"${salesContract.id}");				
			});	
        });	
        ...
        $(window).load(function(){
			...
			function confirm(id){
			window.open("${ctx}/salesContractPreview.do?salesContractId="+id+"&command=orderConfirm",'newwindow1', "toolbar=no,scrollbars=yes,resizable=yes,top=100,left=400, width=750,height=680");
		}
	</script>
	</head>
	<body id="cccc" >
	<c:if test="${param.isNotExist}">
		<script>alert("下载文件失败: 文件不存在");</script>
	</c:if>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
            					...
            					<td class="td_02" >${salesContract.companyContractCode}&nbsp;</td>
        					</tr>
							<tr>
            		...
            		合同章&nbsp;
								...
								<td class="td_02" width="30%">
									<logic:equal value="0" property="templateType" name="salesContract">标准模板&nbsp;</logic:equal>
									<logic:equal value="1" property="templateType" name="salesContract">自定义模板&nbsp;</logic:equal>
									<logic:equal value="2" property="templateType" name="salesContract">非模板&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            	</logic:equal>
								</td>
							</tr>
							...
							<tr id="tdOfcontractProName">
            					<td class="td_01" >&nbsp;项目名称</td>
            					<td class="td_02"  colspan="3">${salesContract.contractProName}&nbsp;</td>
							</tr>
            		...
            		增值税
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								<th nowrap="nowrap" width="40" style="border-left:1px solid #c2c2c2;">
									序号
								</th>
								<th nowrap="nowrap">
									产品编码
							...
							<tr>
								...
								<td nowrap="nowrap" style=" text-align:right; border:1px solid #FFFFFF; padding-right:6px; background-color:#FFFFFF">

									&nbsp;
									<fmt:formatNumber value="${salesContract.money}" pattern="#,##0.00"/>

								</td>
								<td colspan="6" nowrap="nowrap" style=" text-align:left; border:1px solid #FFFFFF; padding-left:5px; background-color:#FFFFFF">元</td>
							</tr>
							</tfoot>
						</table>
						<br />
            		...
            		分批
						...
						<br />
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="biao1" id="creditTable">
							<tr>
								<th nowrap="nowrap">
									信用类型
								</th>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="biao3">
							<tr>
								<td class="td_03" width="20%" nowrap;>
									特殊说明
								</td>
								...
								<table width="98%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td style="padding:5px 0 5px 0;" name="tdLegal" width="330px">
											${tf:replaceBr(salesContract.areaMajText)}
										</td>
									</tr>
								</table>
							</td>
						...
						<tr>
							<td height="20px">
								签字：&nbsp; ${salesContract.areaMajName}
							</td>
							<td>
								日期：&nbsp; ${salesContract.areaMajDate}
							</td>
						</tr>
						<tr>
							<td height="20px" colspan="2">&nbsp;
				...
				<tr>
					...
					<td height="50px" align="center" valign="bottom">
						<a href=#><img src="${ctx}/images/btnYuLan.gif" width="65" height="20"
							class="preview" /></a>
						<c:if test='${salesContract.creditTypeId==4&&salesContract.agreementCode!=""}'>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="javascript:confirm('${salesContract.id}')"><img src="${ctx}/images/btnXYHTYL.jpg" class="buttonNoPrint" /></a>
					</c:if>
                        <a href="${ctx}/downloadFile.do?fileName=${salesContract.fileName}&salesContractId=${salesContract.id}"><img src="${ctx}/images/btnXiaZai.gif" width="65" height="20"
						    class="downLoadIMG" /></a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="${ctx}/getSalesContractsList.do?init=true">
