...
<body>
<html:form action="getStockMoveAudit" styleId="auditkForm" >
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td class="ye_header_center"><img src="${ctx}/images/main_jt.jpg" />&nbsp; 当前位置： 库存管理 &gt;&gt; 发货管理 &gt;&gt; 移库单评审</td>
    ...
    <td><br />
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="biao3">
        <tr>
          ...
          <td class="td_04" style="padding:5px 100px 5px 5px">${assessDto.text}&nbsp;</td>
        </tr>
      </table>
      <br />
                    ...
                    <tr>
                      ...
                      <td style="padding:5px 0 5px 0;">
                      	<c:choose>
                      		...
                      		<c:otherwise>${assessDto.inAdmText }&nbsp;</c:otherwise>
                      	</c:choose>
                      </td>
                    </tr>
                </table>
