...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td class="ye_header_center"><img src="${ctx}/images/main_jt.jpg" />&nbsp; 当前位置： 库存管理 &gt;&gt; 移库管理 &gt;&gt; 移库单查看</td>
    ...
    <td><br />
      ...
      <div class="div_tiao"> &nbsp;&nbsp;评审意见</div>
            <table border="0"  cellpadding="0" cellspacing="0" align="center" width="460">
              <c:if test="${assessDto.type==1}">
              <tr>
                <td height="20px" colspan="2" >采购主管评审意见：</td>
              </tr>
              <tr>
                <td width="320" nowrap="nowrap">&nbsp;</td>
                <td height="20px" width="140" nowrap="nowrap"><input type="checkbox" name="moveStockAssess.buyManIdea" id="buyManIdea1" value="1" disabled="disabled"
             ...
             <c:set value="checked" var="productSumPass" scope="page"></c:set>
              ...
              <tr>
                <td width="320">1.产品规格是否符合</td>
                <td height="20px" width="140">
        ...
        <c:if test="${assessDto.inAdmIdea!=null && fn:substring(assessDto.inAdmIdea,2,3)==1}">
          <c:set value="checked" var="productSumPass2" scope="page"></c:set>
              ...
              <tr>
                <td width="320">1.产品规格是否符合</td>
                <td height="20px" width="140">
				  <input type="checkbox" id="productSpec1" value="1" name="productSpec" ${disabled } ${productSpecPass2}/>符合&nbsp;&nbsp;
                  <input type="checkbox" id="productSpec0" value="0" ${disabled } name="productSpec" ${productSpecUnpass2}/>不符合
				</td>
              </tr>
              <tr>
                <td>2.产品质量是否符合</td>
                <td height="20px">
				  <input type="checkbox" ${disabled } name="productQuality" id="productQuality1" value="1" ${productQualityPass2}/>符合&nbsp;&nbsp;
                  <input type="checkbox" name="productQuality" id="productQuality0" value="0" ${disabled } ${productQualityUnpass2}/>不符合
				</td>
              </tr>
              <tr>
                <td>3.产品数量是否符合</td>
                <td height="20px">
				  <input type="checkbox" ${disabled } value="1" id="productSum1" name="productSum" ${productSumPass2}/>符合&nbsp;&nbsp;
                  <input type="checkbox" ${disabled } value="0" id="productSum0" name="productSum" ${productSumUnpass2}/>不符合
				</td>
              </tr>
  ...
  <tr>
    <td></td>
    <td height="50px" align="center" valign="bottom"><a href="${ctx}/getMoveStockList.do"><img src="${ctx}/images/btnBack.gif" /></a> </td>
    <td></td>
  </tr>
</table>
<br />
