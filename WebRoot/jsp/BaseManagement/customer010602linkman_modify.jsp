...
<html>
	<head>
		...
		function check(){
			...
			token = false;
		$.ajax({
				url:"${ctx}/customer.do?method=saveLinkman",
	...
	<body>
		...
		<input type="hidden" name="supplier.linkmanId" id="linkmanId" style="width:240px;" value="${supplierInfo.linkmanId}" />
		<input type="hidden" name="supplier.id" id="id" style="width:240px;" value="${supplierInfo.id}" />
				...
				<tr>
					...
					<td class="td_02">
						<input type="text" name="supplier.mail" id="mail"
							style="width:240px;" value="${supplierInfo.mail }" maxlength="50"/>
					</td>
				</tr>
				<tr>
					<td class="td_01">
