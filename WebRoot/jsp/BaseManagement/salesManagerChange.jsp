...
var myArray3=new Array();
	...
	function newWindow(){
		...
		window.open('searchUser.do?method=salesManagerAddCustomer&id='+id, '添加客户', 'height=420, width=600, top=200, left=400, toolbar=no, scrollbars=yes,resizable=yes,location=no, status=no');
	};
	function newWindow1_(myArray4124){
		...
		for(var i=0;i<myArray4124.length;i++){
			var customer = myArray4124[i].split(",");
			//添加一行
	        ...
	        //设置列内容和属性
	        newTd0.innerHTML = '&nbsp;<input type="checkbox" name="customer" checked="checked" value="'+customer[0]+'">';
	...
	function fanren_() {
		var customers = document.getElementsByName("customer")
		for(var i=0;i<customers.length;i++){
			var obj = customers[i];
			var id =obj.value;
			var name =obj.parentNode.parentNode.childNodes[1].innerHTML;
			myArray3.push([id+","+name]);
		}
		//alert(myArray3);
	};
...
<input type="hidden" name="changeid" value="4">
    ...
    <br />
    	<table width="100%" border="0" cellpadding="0" cellspacing="0"  class="biao3">
            ...
            <tr>
              ...
              <td class="td_02"><input type="text" name="msn" style="width:240px;" value="${view.msn}" maxlength="30"/></td>
              <td class="td_01">&nbsp;&nbsp;QQ</td>
              <td class="td_02"><input type="text" name="qq" style="width:120px;" value="${view.qq}" maxlength="12"/></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="td_01"><span style="color:#FF0000">*</span>&nbsp;所属区域</td>
              <td class="td_02">
	              <select name="user_area_id" style=" width:126px">
					<logic:iterate id="li" name="userArea">
              					<c:if test="${view.user_area_id==li.area_id}">
...
<div class="div_tiao">&nbsp;负责客户</div>
    	<table width="50%" border="0" cellpadding="0" cellspacing="0" class="biao1" id="table1">
        	...
        	<logic:iterate id="customer" name="customer">
	        	<tr>
	            	<td>&nbsp;<input type="checkbox" name="customer" value="${customer.id}" checked="checked"></td>
	                <td>${customer.name}</td>
	            </tr>
            </logic:iterate>
        </table>
...
<table border="0" cellpadding="0" cellspacing="0" width="50%" id="ec_table">
  <tr>
    <td width="41px" align="left">&nbsp;&nbsp;<input type="checkbox" onclick="javascript:che1(this);">
    <td width="50px">全选</td>
    <td align="center"><!-- <img src="${ctx}/images/btnDelete.gif" /> --></td>
    <td align="left"><a href="javascript:newWindow();"><img src="${ctx}/images/btnAdd.gif" /></a></td>
    <td align="right">&nbsp;</td>
  </tr>
</table>
</td>
