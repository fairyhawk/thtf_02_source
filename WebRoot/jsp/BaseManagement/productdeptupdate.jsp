...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td class="ye_header_center"><img src="${ctx}/images/main_jt.jpg" /> &nbsp;当前位置： 基础信息管理 &gt;&gt; 产品部门信息管理 &gt;&gt; 产品部门修改 </td>
  ...
  <tr>
    ...
    <td align="center"><br />
      <html:form action="/productdeptmanagement" method="post">
        <input type="hidden" name="method" value="saveProductDeptUpdate" />
        <table width="100%" border="0" cellpadding="0" cellspacing="0"  class="biao3">
          <tr>
            <td nowrap="nowrap" class="td_01"><span style="color:#FF0000">*</span>&nbsp;产品部门编号</td>
            <td class="td_02"><input type="text" name="productdept.no" value="${productdeptq.no}" id="id" maxlength="4" style="width:120px;"/>
              <input type="hidden" name="ss" value="${productdeptq.id}"/>
              <input type="hidden" name="err" id="err" value="${err}"/>
            </td>
            <td class="td_01"><span style="color:#FF0000">*</span>&nbsp;产品部门名称</td>
            <td class="td_02"><input type="text" name="productdept.name" value="${productdeptq.name}" id="name"
										maxlength="8" style="width:120px;"/>
            </td>
          </tr>
          <tr>
            <td nowrap="nowrap" class="td_01"><span style="color:#FF0000">*</span>&nbsp;帐号</td>
            <td class="td_02"><input type="text" name="productdept.account" value="${productdeptq.account}" id="account"
										maxlength="20" style="width:120px;"/>
            </td>
            <td class="td_01"><span style="color:#FF0000">*</span>&nbsp;传真</td>
            <td class="td_02"><input type="text" name="productdept.fax" value="${productdeptq.fax}" id="fax"
										maxlength="20" style="width:120px;"/>
            </td>
          </tr>
        </table>
        <table border="0" cellpadding="0" cellspacing="0" width="400px"
							id="ec_table">
          <tr>
            <td align="center" height="50px" valign="bottom"><a href="javascript:sub();"> <img src="${ctx}/images/btnUpdate.gif" width="65" height="20" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a href="javascript:window.location='${ctx}/productdeptmanagement.do?method=productDeptAll';"><img
