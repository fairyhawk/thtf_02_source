...
<html>
	<head>
		...
		token = false;
		$.ajax({
			url:"${ctx}/supplier.do?method=saveAddress",
	...
	<body>
		<br />
		<html:form action="/supplier.do?method=saveAddress" method="post">
				...
				<tr>
					...
					<td class="td_04">
						...
						<input type="text" name="supplier.receiveName"
							...
							value="${supplierInfo.receiveName }" />
					</td>
				</tr>
				<tr>
					<td class="td_03">
				...
				<tr>
					...
					<td class="td_04">
						<input type="text" name="supplier.supplierTel"
							...
							value="${supplierInfo.supplierTel }" />
					</td>
				</tr>
				<tr>
					<td class="td_03">
