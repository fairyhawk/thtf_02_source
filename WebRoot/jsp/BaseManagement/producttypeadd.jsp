...
<html>
	...
	<head>
		...
		var formId = 0;
		//控件名
		var checknNames = ["producttype.name", "productdept.id"];
		//提示语
			...
			<tr>
				...
				<td align="center">
					...
					<html:form action="/producttypemanagement" method="post">
						<input type="hidden" name="method" value="ProductTypeAdd" />
						<table width="100%" border="0" cellpadding="0" cellspacing="0"  class="biao3">
							<tr>
								...
								<td class="td_02" width="30%">
									<input type="text" name="producttype.name" id="name" maxlength="12" style="width:120px;"/>
								</td>
							</tr>
							<tr>
								...
								<td class="td_02">
									<label>
										<select name="productdept.id" id = "se" style=" width:126px">
							...
							<tr>
								<td align="center" height="50px" valign="bottom">
									...
									<a href="javascript:window.location='${ctx}/producttypemanagement.do?method=productTypeAll'">
										<img src="${ctx}/images/btnBack.gif" width="65" height="20" /></a>
								</td>
							</tr>
						</table>
					</html:form>
