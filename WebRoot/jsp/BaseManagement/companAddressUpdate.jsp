...
<html>
	...
	<body onload="checks();">
		...
		<html:form action="/companyadress" method="post">
						<input type="hidden" name="method" value="companyAddressUpdate" />
		<table width="96%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="td_04">
					<input type="text" name="companyaddress.name" id="name" style="width:240px;" maxlength="40" value="${cainfo.name}"/>
					<input type="hidden" name="companyaddress.id" value="${cainfo.id}"/>
			...
			<tr>
				...
				<td class="td_02">
					<input type="text" name="companyaddress.address" id="address" style="width:480px;" maxlength="40" value="${cainfo.address}"/>
				</td>
			</tr>
			<tr>
				<td class="td_01">
				...
				<td class="td_02">
					<input type="text" name="companyaddress.postcode" id="postcode" style="width:120px;" maxlength="6" value="${cainfo.postcode}"/>
				</td>
			</tr>
			<tr>
				<td class="td_01">
				...
				<td class="td_02">
					<input type="text" name="companyaddress.linkman" id="linkman" style="width:120px;" maxlength="4" value="${cainfo.linkman}"/>
				</td>
			</tr>
			<tr>
				<td class="td_01">
				...
				<td class="td_02">
					<input type="text" name="companyaddress.tel" id="tel" style="width:120px;" maxlength="20" value="${cainfo.tel}"/>
				</td>
			</tr>
			<tr>
				<td class="td_01">
				...
				<td class="td_02">
					<input type="text" name="companyaddress.mobile" id="mobil" style="width:120px;" maxlength="12" value="${cainfo.mobile}"/>
				</td>
			</tr>
		</table>
		<br />
		<table width="400" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<a href="javascript:check();">
					<img src="${ctx}/images/btnUpdate.gif" width="65" height="20" />
					</a>
				</td>
			</tr>
		</table>
