...
<script type="text/javascript">
	...
	function newWindow21_(myArray,regionalName){
		...
		for(var i=0;i<myArray.length;i++){
	        ...
	        //设置列内容和属性
	        newTd0.innerHTML = '&nbsp;<input type="checkbox" checked="checked" name="grqwrewq1" value="'+customer[0]+','+customer[1]+'">';
	...
	function newWindow21(myArray,regionalName){
		...
		if(myArray.length==0){
			if(myArray1.length==0){
				...
				newWindow21_(myArray1,regionalName);
				myArray1=myArray1;
			}
		}else{
			if(myArray1.length==0){
				...
				newWindow21_(unique(myArray_.concat(myArray1)),regionalName);
				myArray1=unique(myArray_.concat(myArray1));
			}
		}
	};
	function che2(a) {
		var all=document.getElementsByName("grqwrewq1");
		if(a.checked==true){
	...
	function fanren_() {
		var customers = document.getElementsByName("grqwrewq1")
...
<input type="hidden" name="changeid" value="7">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
   ...
   <tr>
    ...
    <br />
    	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="biao3">
            ...
            <td class="td_02"><select name="user_dept_id" style=" width:126px">
  ...
  <tr>
    ...
    <br/><div class="div_tiao" style="font-size:12px;">&nbsp;负责库房产品</div>
    	<table width="50%" border="0" cellpadding="0" cellspacing="0" class="biao1" id="table">
          ...
          <logic:iterate id="TreasuryProducts" name="TreasuryProducts">
	          <tr>
	            <td align="right">&nbsp;<input name="grqwrewq1" checked="checked" type="checkbox" value="${TreasuryProducts.product_type_id},${TreasuryProducts.stockroom_id}"></td>
	            <td align="right">${TreasuryProducts.area_name}</td>
	            <td align="right">${TreasuryProducts.type_name}</td>
	          </tr>
          </logic:iterate>
        </table>
    	<br />
        <table border="0" cellpadding="0" cellspacing="0" width="50%" id="ec_table">
        	<tr>
              ...
              <td width="50px" style="font-size:12px;">全选</td>
                <td align="left"><a href="javascript:newWindow1123();"><img src="${ctx}/images/btnAdd.gif" /></a></td>
                <td align="center" width="100px"><!-- <img src="${ctx}/images/btnDelete.gif" /> --></td>
          </tr>
        </table>    </td>
    <td >&nbsp;</td>
  </tr>
  <tr>
    ...
    <a href="javascript:clickSubmit();"><img src="${ctx}/images/btnUpdate.gif" /></a>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
