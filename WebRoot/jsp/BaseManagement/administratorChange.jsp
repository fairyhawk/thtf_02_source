    ...
    <br/>
    	<table width="100%" border="0" cellpadding="0" cellspacing="0"  class="biao3">
			...
			<tr>
				...
				<td class="td_02" nowrap>
					<input type="text" name="newPassword" maxlength="40" style="width:120px;"/>&nbsp;<span style="color:#FF0000">*如填写将变更用户密码</span><input type="hidden" name="password" value="${view.password}" maxlength="40"/>
				</td>
			</tr>
            <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="300px" id="ec_table">
        	<tr>
            	<td height="50px" valign="bottom" align="center"><a href="javascript:clickSubmit();"><img src="${ctx}/images/btnUpdate.gif" width="65" height="20"/></a>
            	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            	<a href="javascript:window.location = '${ctx}/searchUser.do?method=searchUserBefore';"><img src="${ctx}/images/btnBack.gif" width="65" height="20" /></a></td>
            </tr>
        </table>
    </td>
  </tr>
