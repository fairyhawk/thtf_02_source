...
<script type="text/javascript" src="${ctx}/js/jquery-1.4.2.min.js"></script>
		...
		<!--
			$(document).ready(function(){
				if($("#tableqwef")){
					$("#tableqwef tr:even").addClass("treven");
					$("#tableqwef tr").each(function(i){
...
<script type="text/javascript">
	...
	function submit() {
		window.opener.newWindow21(myArray);
		window.close();
	};
	...
	function proChange(id,regional){
		...
		var url = "${ctx}/searchUser.do?method=salesAssistantAddBeforeCheck1&regional="+regional+"&product="+id;
	...
	function toRegional(Regional){
		...
		var tableqwef = document.getElementById("tableqwef");
...
<table width="96%" border="0" cellpadding="0" cellspacing="0" align="center" class="biao3" >
	<tr>
    	<td class="td_03" width="50%">库房选择</td>
    	<td class="td_04" width="50%">
	    	<select name="regional1112" style=" width:264px" onChange="javascript:toRegional(this);">
	    		<logic:iterate id="regional" name="treasury">
...
<br>
<table width="96%" border="0" cellpadding= 	"0" cellspacing="0" align="center" class="biao1" id="tableqwef">
	<tr>
		<th width="41">选择</th>
		<th>产品分类名称</th>
		<th>是否允许添加</th>
